...
import 'package:football_app/Screens/profilescreen.dart';

import 'package:football_app/Screens/tablesscreen.dart';
...
class InitialScreenState extends State<InitialScreen> {
  ...
  void initState() {
    ...
    bottomItemList.add(BottomModel(name:"Home", icon:Icons.home));
    bottomItemList.add(BottomModel(name:"Scores", icon:Icons.sports_football));
    bottomItemList.add(BottomModel(name:"PL", icon: Icons.table_chart));
    bottomItemList.add(BottomModel(name:"Profile", icon:Icons.more_vert));
            ...
            children: [
              Container(
                ...
                child: Container(
                  ...
                  //padding: EdgeInsets.only(top: MediaQuery. of(context). viewPadding.top),
                  child: currentTabIndex == 1? HomeScreen():
                  currentTabIndex == 2?TableScreen():
                  currentTabIndex == 3? ProfileScreen():
                  AddsScreen(),
                ),
              ),
              Container(
